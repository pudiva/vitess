...
const TablesWithSize56 = `SELECT table_name, table_type, unix_timestamp(create_time), table_comment, 0, 0
...
// per query.
const TablesWithSize57 = TablesWithSize56
...
// per query.
const TablesWithSize80 = TablesWithSize56
